...
*(no published results page yet — first one lands when Unit 8 of [docs/plans/2026-05-21-001-feat-benchmark-harness-plan.md](../plans/2026-05-21-001-feat-benchmark-harness-plan.md) runs on the maintainer's hardware.)*
